...
//                         const descriptionButton = document.createElement('button');
//                         descriptionButton.innerText = 'Description';
//                         descriptionButton.onclick = () => showModal('descriptionModal', project.description || [], document.querySelector('.carousel-item-ocr.active'));
//                         linksContainer.appendChild(descriptionButton);

//                         const competenceButton = document.createElement('button');
//                         competenceButton.innerText = 'Compétence';
//                         competenceButton.onclick = () => showModal('competenceModal', project.competences || [], document.querySelector('.carousel-item-ocr.active'));
//                         linksContainer.appendChild(competenceButton);

//                         const problematiqueButton = document.createElement('button');
//                         problematiqueButton.innerText = 'Problématique';
//                         problematiqueButton.onclick = () => showModal('problematiqueModal', project.problematique || [], document.querySelector('.carousel-item-ocr.active'));
//                         linksContainer.appendChild(problematiqueButton);
...
//                         const problematiqueButton = document.createElement('button');
//                         problematiqueButton.innerText = 'Problématique';
//                         problematiqueButton.onclick = () => showModal('problematiqueModal', project.problematique || []);
//                         linksContainer.appendChild(problematiqueButton);
