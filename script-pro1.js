        ...
        fetch('datas/pro.json')
            ...
            .then(carouselData => {
                ...
                carouselData.forEach((item, index) => {
                    ...
                    image.style.display = 'block'; // Force display of image
                ...
                function showProCarouselItem(index) {
                    ...
                    items[index].style.display = 'block'; // Show current item
                    items[index].classList.add('active'); // Add active class
...
//                     const image = document.createElement('img');
//                     image.setAttribute('src', item.cover);
//                     image.style.display = 'block'; // Force display
//                     carouselItem.appendChild(image);
//                     carouselContainer.appendChild(carouselItem);
